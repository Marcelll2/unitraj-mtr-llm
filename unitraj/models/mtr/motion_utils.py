...
def get_ade_of_waymo(pred_trajs, gt_trajs, gt_valid_mask, calculate_steps=(5, 9, 15)) -> float:
    ...
    if pred_trajs.shape[2] == 80:
        pred_trajs = pred_trajs[:, :, 4::5] # downsampling to 16， because the pred_len is 80， and every 5th frame is used
        gt_trajs = gt_trajs[:, 4::5] # downsampling 
        gt_valid_mask = gt_valid_mask[:, 4::5] # downsampling 
